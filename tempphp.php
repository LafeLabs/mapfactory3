...
//this is a replicator specific to the object artbox

    $url = "http://www.lafelabs.org/artbox/json/artbox.txt";
...
<a href = "index.php" style = "font-size:5em;">index.php?path=maps/artbox.txt</a>
